...
{
    public class BaseCatchInteractable : Interactable
    {
        /// <summary>
        /// 被拿起的3D物体
        /// </summary>
        ...
        {
            canCatch = true;
            _gameObject3D = GetComponent<Rigidbody>();
        ...
        public void LockRotation(Vector3 target)
        {
        ...
        public void SetCanCatch(bool isCan)
        {
            canCatch = isCan;
        }
    }
